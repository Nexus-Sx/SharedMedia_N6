...
LSM:Register("statusbar", "<N6> Flat Dark", [[Interface\Addons\SharedMedia_N6\statusbar\Flat-Dark.tga]])
LSM:Register("statusbar", "<N6> Flat Light", [[Interface\Addons\SharedMedia_N6\statusbar\Flat-Light.tga]])
